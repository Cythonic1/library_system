...
# SQLALCHEMY_DATABASE_URL = "mssql+pyodbc://webapp:Yasser00@192.168.122.89:1433/website?driver=ODBC+Driver+17+for+SQL+Server"
SQLALCHEMY_DATABASE_URL = "postgresql://postgres:123123@localhost:5432/website"
