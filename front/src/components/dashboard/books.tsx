...
export default function BooksPage() {
  ...
  const { mutate: DeleteBookMutation } = useMutation({
    ...
    onSuccess: () => {
      ...
      setBooks(
        books.filter((book: any) => book.book_id !== currentBook.book_id),
      );
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewBook({ ...newBook, counter: Number(e.target.value) })
                  }
                  className="col-span-3"
                />
              </div>
            ...
            <DialogFooter>
              <Button
                type="submit"
                onClick={() => createBookMutation()}
                disabled={!newBook.title || !newBook.author || isLoading}
              >
                Add Book
              </Button>
            </DialogFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage your digital library books. Total books: {books.length}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-4">
                ...
                {filteredBooks.length === 0 ? (
                  ...
                  filteredBooks.map((book: any) => (
                    <TableRow key={book.id}>
                      ...
                      <TableCell className="hidden md:table-cell">
                        <Badge variant={book.availability_status}>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setCurrentBook({ ...currentBook, url: e.target.value })
                  }
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  id="edit-url"
                  value={currentBook.counter}
                  type="number"
                  onChange={(e) =>
                    setCurrentBook({ ...currentBook, counter: e.target.value })
                  }
                  className="col-span-3"
                />
              </div>
